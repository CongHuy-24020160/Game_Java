...
public class AttachSystem extends IteratingSystem {
    ...
    protected void processEntity(Entity entity, float v) {
        ...
        if(LinkedEntityComponent.LinkedEntity == null) {
            return;
        }
        ...
        final PhysicsBodyComponent childB2Body = b2BodyComponentComponentMapper.get(LinkedEntityComponent.LinkedEntity);
