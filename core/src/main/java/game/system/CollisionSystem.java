...
public class CollisionSystem extends IteratingSystem {
    ...
    final ComponentMapper<ColliderComponent> collisionC
        = ComponentMapper.getFor(ColliderComponent.class);
    final ComponentMapper<PhysicsBodyComponent> b2BodyC
        = ComponentMapper.getFor(PhysicsBodyComponent.class);
    final ComponentMapper<BallComponent> ballC
        = ComponentMapper.getFor(BallComponent.class);
    final ComponentMapper<TypeComponent> typeC
        = ComponentMapper.getFor(TypeComponent.class);
    final ComponentMapper<TextureComponent> textureC
