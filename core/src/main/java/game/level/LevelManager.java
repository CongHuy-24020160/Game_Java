...
import game.component.MoveComponent;
...
public class LevelManager implements Disposable {
    ...
    private void createBrick(float x, float y, Texture texture, int id) {
        ...
        PhysicsBodyComponent body = en.createComponent(PhysicsBodyComponent.class);
        MoveComponent transform = en.createComponent(MoveComponent.class);
